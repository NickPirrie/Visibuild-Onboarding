...
export function seedProjects() {
  const a = {
    ...
    phase2End: '2026-08-17',
    phase3End: '2026-11-17',
...
export function newProject() {
  ...
  return {
    ...
    phase2End: golive.toISOString().slice(0, 10),
    phase3End: new Date(new Date(today).setDate(new Date(today).getDate() + 150)).toISOString().slice(0, 10),
    csOwner: '',
    workstreams: mkWorkstreams(),
    subcontractors: [],
    correspondences: [],
